      ...
      {isSOSActive && (
        ...
        <div className="fixed inset-0 bg-pink-700/95 z-50 overflow-y-auto">
          ...
          <div className="min-h-screen flex flex-col items-center justify-center text-white px-6 py-10 text-center">
            ...
            <p className="text-xl text-pink-100 mb-6 max-w-sm">
              {sendingMessage}
            </p>
            ...
            {location && (
              ...
              <div className="w-full max-w-sm space-y-4 mb-8">
                ...
                {/* Coordinates */}
                <div className="bg-white/10 border border-white/20 rounded-2xl p-4 text-sm">
                ...
                <a
                  ...
                  className="block w-full bg-pink-500 hover:bg-pink-600 text-white py-3 rounded-2xl font-semibold text-center transition"
                >
                  Open in Google Maps
                </a>
...
Please contact me immediately.`
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="block w-full bg-green-500 hover:bg-green-600 text-white py-3 rounded-2xl font-semibold text-center transition"
                >
                  Share via WhatsApp
                </a>
